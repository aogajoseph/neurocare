        ...
        <div className="pb-12 md:pb-20">
          ...
          <div className="mx-auto max-w-3xl pb-12 text-center md:pb-20">
            ...
            <p className="text-lg text-indigo-200/65">
              Through advocacy, media and partnerships, we connect stories to solutions, ensuring every affected individual is seen, supported and empowered to thrive.
            </p>
          </div>
          {/* Spotlight items */}
                ...
                <div className="p-6">
                  <div className="mb-3">
                    <span className="btn-sm relative rounded-full bg-gray-800/40 px-2.5 py-0.5 text-xs font-normal before:pointer-events-none before:absolute before:inset-0 before:rounded-[inherit] before:border before:border-transparent before:[background:linear-gradient(to_bottom,--theme(--color-gray-700/.15),--theme(--color-gray-700/.5))_border-box] before:[mask-composite:exclude_!important] before:[mask:linear-gradient(white_0_0)_padding-box,_linear-gradient(white_0_0)] hover:bg-gray-800/60">
                      <span className="bg-linear-to-r from-[#aa2078] to-[#fffff0] bg-clip-text text-transparent">
                        Raising Awareness
                      </span>
                    </span>
                  </div>
                  <p className="text-indigo-200/65">
                    Educating the public to reduce stigma around neurological conditions.
                  </p>
                </div>
              </div>
            </a>
