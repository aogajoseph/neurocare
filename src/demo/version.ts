...
export const versionData = {
  hero: {
    title: {
      en: 'Version & Updates',
      sw: 'Toleo na Masasisho',
    },
    subtitle: {
      en: 'Information about app versions, updates, and improvements.',
      sw: 'Taarifa kuhusu matoleo ya programu, masasisho, na maboresho.',
    },
  },
  ...
  sections: [
    ...
    },
    {
      id: 'data',
      title: {
        en: 'Content & Data Updates',
        sw: 'Masasisho ya Maudhui na Taarifa',
      },
      description: {
        en: 'Some updates may occur automatically as new verified content becomes available. These updates help ensure information remains accurate, relevant, and up to date.',
        sw: 'Baadhi ya masasisho yanaweza kufanyika kiotomatiki kadri maudhui mapya yaliyothibitishwa yanavyopatikana. Hii husaidia kuhakikisha taarifa zinabaki sahihi na za kisasa.',
      },
    },
    {
      id: 'future',
