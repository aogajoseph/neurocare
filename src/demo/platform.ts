export const platformData = {
  ...
  sections: [
    ...
    },
    {
      id: 'who',
      title: {
        en: 'Who This Platform Is For',
        sw: 'Jukwaa Hili Ni Kwa Ajili ya Nani',
      },
      content: {
        en: `This platform serves people living with neurological conditions, caregivers, healthcare partners, advocates, and organizations working in neurological care and disability support.`,
        sw: `Jukwaa hili linahudumia watu wanaoishi na magonjwa ya mfumo wa neva, walezi, washirika wa afya, watetezi na mashirika yanayofanya kazi katika huduma ya neurologia na ulemavu.`,
      },
    },
    {
      id: 'values',
