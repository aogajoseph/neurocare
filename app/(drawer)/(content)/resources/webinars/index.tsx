...
export default function WebinarsScreen() {
  ...
  const webinarsResource = resources.find((r) => r.slug === 'recorded-webinars');

  if (!webinarsResource) {
    return (
      <View style={styles.center}>
        <Text>Webinars resource not found.</Text>
      </View>
    );
  }
  ...
  return (
    <>
      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <Text style={styles.title}>{webinarsResource.title.en}</Text>
        <Text style={styles.subtitle}>{webinarsResource.subtitle.en}</Text>

        {/* Video Items */}
        {webinarsResource.items.map((item) => {
